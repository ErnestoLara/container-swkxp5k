...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-swkxp5k.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-swkxp5k.containers.anotherwebservice.com/
...
```
git clone git@github.com:ErnestoLara/container-swkxp5k.git
cd container-swkxp5k
```
...
```
docker attach container-swkxp5k
```
